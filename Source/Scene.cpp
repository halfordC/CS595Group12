...
Scene::Scene(myKissGUI* kissGUI, kiss_window *mainWindow, Translator* t)
{
	...
	staticX = 40;
	currentY = 70;
	imgParameters *firstIMPar = new imgParameters(staticX, currentY, addImgParamIndex + 1, kissGUI, &sceneWindow, addImgParamIndex + 1, translator);
...
void Scene::addImg()
{
	if (addImgParamIndex < 15)
	{
		...
		imgParameters* nextIMPar = new imgParameters(40, currentY, addImgParamIndex + 1, sceneKissGUI, &sceneWindow, addImgParamIndex + 1, translator);
